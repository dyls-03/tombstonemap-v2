            ...
            <div className="mx-auto max-w-4xl">
                ...
                <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl">
                    ...
                    <p className="mt-4 leading-relaxed text-white/65">
                        Just because you&apos;ve jumped at a spot before does not mean it is
                        safe to jump again without checking the depth and landing area first.
                        Outdoor conditions can change rapidly due to tides, currents,
                        weather and natural movement underwater.
                    </p>

                    <p className="mt-4 leading-relaxed text-white/65">
                        Entering the water carefully before jumping can also help your body
                        acclimatise to the temperature and may reduce the intensity of{" "}
                        <a
